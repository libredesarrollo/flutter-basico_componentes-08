...
class _BoxPageState extends State<BoxPage> with SingleTickerProviderStateMixin {
  ...
  Animation<double> _sizeAnimation, _rotationAnimation, _opacityAnimation;

  Animation<Offset> _translateAnimate;

  Animatable<Color> backgroundAnimate;
  ...
  void initState() {
    ...
    backgroundAnimate = TweenSequence<Color>([
      TweenSequenceItem(
          weight: 2.0, tween: ColorTween(begin: Colors.red, end: Colors.green)),
      TweenSequenceItem(
          weight: 1.0,
